...
3. Muestra/oculta herramientas: filtros, selector de columnas, orden, botón de
   reporte y "nuevo trámite". **La Agenda, la Config y el Dashboard ocultan
   la barra de herramientas** (`hideTools`).
...
color, tema y auto-requerimiento. Cada control tiene su
